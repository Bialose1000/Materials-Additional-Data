...
youngsmodulus("Modulus_Steel_1.csv")
youngsmodulus("Modulus_Steel_2.csv")
youngsmodulus("Modulus_Steel_3.csv")
youngsmodulus("Modulus_Steel_4.csv")
youngsmodulus("Modulus_Steel_5.csv")